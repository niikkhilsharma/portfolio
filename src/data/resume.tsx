...
export const DATA = {
	...
	contact: {
		...
		social: {
			GitHub: {
				name: 'GitHub',
				url: 'https://github.com/niikkhilsharma',
				icon: Icons.github,
				navbar: true,
			},
			...
			LinkedIn: {
				name: 'LinkedIn',
				url: 'https://linkedin.com/in/niikkhilsharma',
				icon: Icons.linkedin,
				navbar: true,
			},
			X: {
				name: 'X',
				url: 'https://x.com/nikhil_dmg',
				icon: Icons.x,
				navbar: false,
			},
			// Youtube: {
			...
			email: {
				name: 'Send Email',
				url: 'mailto:niikkhilsharma@gmail.com?subject=Hello&body=Hi%20Nikhil,',
				icon: Icons.email,
	...
	education: [
		{
			...
			logoUrl: '/assets/education-logo/rtu.png',
			start: '2021',
			end: '2025',
		},
		{
			school: 'Sophia Senior Secondary School',
			href: 'https://sophiaschool.com/',
			degree: 'Class 12 - Senior Secondary Education',
			logoUrl: '/assets/education-logo/sophia.png',
			start: '2019',
			end: '2021',
		},
		{
			school: 'Army Public School Kota',
			href: 'https://apskota.com/',
			degree: 'Class 10 - Secondary Education',
			logoUrl: '/assets/education-logo/aps-kota.png',
			start: '2011',
			end: '2019',
		},
	],
	projects: [
		...
		// },
		{
			...
			active: true,
			description:
				'A cinematic gaming landing page with scroll-driven GSAP animations — built to showcase fluid motion design and a visually rich metagame aesthetic.',
			technologies: ['React', 'Vite', 'JavaScript', 'TailwindCSS', 'GSAP'],
			links: [
				{
					type: 'Website',
					href: 'https://metagame.itsnikhil.in/',
				...
				{
					type: 'Source',
					href: 'https://github.com/niikkhilsharma/award-site-js',
					icon: <Icons.github className="size-3" />,
				},
			],
			image: '',
		...
		},
		{
			...
			active: true,
			description:
				'Built an AI-powered document chat app that lets users upload PDFs and have natural conversations with their docs. The project uses [LangChain](https://www.langchain.com/), [OpenAI](https://openai.com/), and a MongoDB-backed knowledge store to turn static technical documentation into an interactive learning experience.',
			technologies: [
				'Next.js 14',
				'JavaScript',
				'LangChain',
			...
			links: [
				...
				{
					type: 'Source',
					href: 'https://github.com/niikkhilsharma/chat-docs-library',
					icon: <Icons.github className="size-3" />,
				},
			],
			image: '',
